...
const useSupabase = BACKEND_CONFIG.mode === 'supabase';

export const auth: AuthAdapter = useSupabase ? supabaseAuthAdapter : mvpAuthAdapter;
export const data: DataAdapter = useSupabase ? supabaseDataAdapter : mvpDataAdapter;
