...
const VoiceConcierge: React.FC<VoiceConciergeProps> = ({ isOpen, onClose, context }) => {
  ...
  const startSession = async () => {
    ...
    try {
      ...
      const instruction = `
        You are "Nexus Advisor", a world-class financial mobility strategist. 
        Context: ${JSON.stringify(context)}.
        Your goal is to have a real-time voice conversation with the business owner.
        Be encouraging, professional, and data-driven. 
        Help them understand their Tier 2 path and how to reinvest their Tier 1 funding into high-yield assets.
        Keep responses concise for a voice medium. 
      `;
      ...
      <div className="bg-slate-900 w-full max-w-lg rounded-[3rem] border border-white/10 shadow-[0_0_100px_rgba(16,185,129,0.1)] overflow-hidden flex flex-col relative animate-fade-in">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
            <div className="relative mb-16">
               ...
               <div className="absolute inset-[-40px] rounded-full border border-white/5 animate-[ping_4s_infinite] delay-700"></div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <p className="text-slate-400 font-medium leading-relaxed italic max-w-xs">
                    "I have reviewed your 0% card performance. How can I help you deploy your next capital tranche?"
                </p>
            </div>
        ...
        <div className="p-8 bg-slate-950/50 border-t border-white/5 flex flex-col items-center">
            ...
            <p className="text-[9px] text-slate-600 mt-6 font-bold uppercase tracking-widest">© Nexus Intelligence Operating System</p>
        </div>
      </div>
    </div>
  );
